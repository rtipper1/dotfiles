...
hl.bind(mainMod .. " + SHIFT + RETURN", hl.dsp.exec_cmd(apps.floatingTerminal))
...
-- Inside your hyprland.lua / input config
input = {
    kb_layout = "us",
    kb_options = "caps:escape", -- or "caps:swapescape" to swap both keys
}
